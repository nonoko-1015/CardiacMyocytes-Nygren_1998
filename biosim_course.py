...
::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
       ...
       Copyright (C) 1996-2018 Keio University
       Copyright (C) 2008-2018 RIKEN
...
aSimulator.setDMSearchPath( aSimulator.DM_SEARCH_PATH_SEPARATOR.join( ecell.config.dm_path ) + ":{cwd}/Process:{cwd}:..:../..".format(cwd = os.getcwd()) )
